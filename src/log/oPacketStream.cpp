...
//    serialize[pss_src_packet][pss_pkt_format_written] = ImageFileType2Name(source.format_written);
...
void oPacketStream::writePacket(PacketStreamSourceId src, const char* source, size_t sourcelen)
{
